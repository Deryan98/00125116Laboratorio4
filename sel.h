...
{
    float T = m.getParameter(T_UNKNOWN);
    A.at(0).at(0) += -T / 8;
    A.at(0).at(1) += T / 8;
    A.at(1).at(0) += -T / 8;
    A.at(1).at(1) += T / 8;
...
{
    float ALFA = m.getParameter(ALFA_UNKNOWN);
    C.at(0).at(0) += -3.0 * ALFA / 2;
    C.at(0).at(1) += 3.0 * ALFA / 2;
    C.at(1).at(0) += -3.0 * ALFA / 2;
    C.at(1).at(1) += 3.0 * ALFA / 2;
}

void createLocalG(Matrix &G, mesh m)
{
    float LAMBDA = m.getParameter(LAMBDA_UNKNOWN);
    G.at(0).at(0) += -LAMBDA / 3;
    G.at(0).at(1) += LAMBDA / 3;
    G.at(1).at(0) += -LAMBDA / 3;
    G.at(1).at(1) += LAMBDA / 3;
}

void createLocalI(Matrix &I, mesh m)
{
    float S = m.getParameter(S_UNKNOWN);
    I.at(0).at(0) += -S / 2.0;
    I.at(0).at(1) += S / 2.0;
    I.at(1).at(0) += -S / 2.0;
    I.at(1).at(1) += S / 2.0;
...
void createLocalP(Matrix &P, mesh m)
{
    ...
    float K = m.getParameter(K_UNKNOWN);
    P.at(0).at(0) += K / l;
    P.at(0).at(1) += -K / l;
    P.at(1).at(0) += -K / l;
    P.at(1).at(1) += K / l;
...
{
    float l = m.getParameter(ELEMENT_LENGTH);
    float U = m.getParameter(U_UNKNOWN);
    Q.at(0).at(0) += U / l;
    Q.at(0).at(1) += -U / l;
    Q.at(1).at(0) += -U / l;
    Q.at(1).at(1) += U / l;
...
Vector createLocalb(int element, mesh &m)
{
    ...
    float W = m.getParameter(W_UNKNOWN), N = m.getParameter(N_UNKNOWN), l = m.getParameter(ELEMENT_LENGTH);
