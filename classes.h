...
public:
    void setParameters(float l, float T, float K, float LAMBDA, float U, float W, float ALFA, float S, float N)
    {
        parameters[ELEMENT_LENGTH] = l;
        parameters[T_UNKNOWN] = T;
        parameters[K_UNKNOWN] = K;
        parameters[LAMBDA_UNKNOWN] = LAMBDA;
        parameters[U_UNKNOWN] = U;
        parameters[W_UNKNOWN] = W;
        parameters[ALFA_UNKNOWN] = ALFA;
        parameters[S_UNKNOWN] = S;
        parameters[N_UNKNOWN] = N;
    }
